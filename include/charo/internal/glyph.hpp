...
public:
    ...
    constexpr Glyph(data_t symbol, GlyphStyle styles) : data{symbol}, style{styles} {}
    constexpr Glyph(char symbol, GlyphStyle styles) : data{static_cast<data_t>(symbol)}, style{styles} {}
